  ...
  return (
    ...
    <div className='flex justify-between'>
      <div className='flex flex-col w-1/2 justify-center'>
        <div>
          <h1 className='text-4xl font-bold text-gray-700'>We are here to create a wonderful future for you.</h1>
        </div>
        <div>
          <p className='mt-7 text-justify text-gray-600 text-lg'>To Elevate your organization, you need the right people on your team. You need proficient human resources to upscale your business. Being an executive search firm offering end-to-end recruitment solutions, let us search for the best minds for your company who will help you achieve excellence and build a better future.</p>
          <p className='mt-7 text-justify text-gray-600 text-lg'>Contact Serviam, one of the best recruitment agencies in India.</p>
        </div>
        <div>
