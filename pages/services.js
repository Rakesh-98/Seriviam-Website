    ...
    <div className='px-10 mt-20'>
      ...
      <div className=' flex mt-40 mx-10 justify-between'>
        <div className='text-lg w-1/2 '>
          ...
          <p className='mt-3'>In today’s rapidly changing economic scenarios, companies need a simplified recruitment process that boosts business agility.</p>
          <p className='mt-3'>Serviam makes it easier for organizations to acquire the right talent by offering effective end-to-end RPO solutions, that help them drive cost and quality benefits as well as reduce fill time.</p>
          <p className='mt-3'>We understand that different companies have various recruitment needs so if a company is looking to bring more flexibility and agility to their recruitment functions and overcome various challenges related to recruitment like cost, scalability, and quality, then RPO is perfect for them.</p>
        </div>
        <div className='flex mx-auto'>
          <h1>Illustration</h1>
        </div>
