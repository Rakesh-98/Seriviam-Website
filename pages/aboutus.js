    ...
    <div className='px-10 mt-20'>
      ...
      <div>
        <div className='mt-16 text-xl text-end w-1/2 bg-gray-100 p-5 rounded-sm '>
          ...
          <p className='mt-2 text-gray-600 text-lg'>Serviam will give the client a dedicated recruiter to work with to identify the qualities of their ideal candidate.</p>
        </div>
        <div className='mt-16 text-xl w-1/2 bg-gray-100 p-5 rounded-sm '>
          ...
          <p className='mt-2 text-gray-600 text-lg'>We conduct our search for suitable candidates throughout the organization in unification, enhanced by the added resources that come with proprietary local knowledge, keeping in mind the client's requirements.</p>
        </div>
        <div className='mt-16 text-xl text-end w-1/2 bg-gray-100 p-5 rounded-sm '>
          <h1 className='text-purple-700 font-bold'>Skill-Checking and Telephonic Screening Process</h1>
          <p className='mt-2 text-gray-600 text-lg'>We will then approach the ideal candidates on our client's behalf and conduct various steps like skill-checking and Pre-screening to refine the final selection even further before presenting the client with the CVs.</p>
        </div>
        <div className='mt-16 text-xl w-1/2 bg-gray-100 p-5 rounded-sm '>
          <h1 className='text-purple-700 font-bold'>Refining Process.</h1>
          <p className='mt-2 text-gray-600 text-lg'>Our search professionals focus on our client's specific requirements, a candidate's niche competencies, and functional disciplines while carrying out the recruitment and staffing process.</p>
        </div>
      </div>

      <div className='mt-32 bg-slate-100 px-5 py-7 rounded-3xl'>
        <p className='text-xl text-justify text-gray-600 text-lg'>We also follow the True Fit philosophy. We match the candidate’s mentality and caliber with numerous other factors in our client’s organization. For example, Personality match, personal interests, location, etc. We compare the client’s expectations with the candidate’s characteristics. An employee is the most valuable asset to a company therefore we make sure that the selected candidates are the RIGHT FIT for the company.</p>
